...
var render = function() {
  ...
  return _c("div", { staticClass: "layout-app" }, [
    _c("div", { staticClass: "app-label" }, [
      _vm._v("\n    # Hosting App [HOST]\n  ")
    ]),
    _vm._v(" "),
    _c("img", { attrs: { src: __webpack_require__(520), width: "30" } }),
    _vm._v(" "),
    _c("h1", [_vm._v("Layout App 1")]),
    _vm._v(" "),
    _c(
      "div",
      { staticClass: "remote-component" },
      [
        _c("div", { staticClass: "app-label" }, [
...
/* harmony default export */ const main = (new vue_runtime_esm({
  render: h => h(App)
}).$mount('#app'));
